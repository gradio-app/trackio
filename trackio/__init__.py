...
def log_artifact(
    ...
    Args:
        ...
        overwrite (`bool`, *optional*):
            If `True`, removes every other version of this artifact after the
            new content is logged. Blobs still used by other artifacts are
            preserved, and version numbers continue increasing. Defaults to
            `False`.
