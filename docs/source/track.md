...
- A **self-hosted Trackio server** (HTTP or HTTPS), by passing `server_url` (or setting `TRACKIO_SERVER_URL`) to the full base URL of that server, for example `http://127.0.0.1:7860/`.
