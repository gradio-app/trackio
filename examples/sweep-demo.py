...
Runs two sweeps in the "sweeps-demo" project:
...
def simulated_train():
    ...
    for step in range(30):
        ...
        floor = 0.3 + 0.5 * lr_penalty + dropout
...
print(f"  trackio sweep status {PROJECT}/{grid_sweep_id} --trials")
print(f"  trackio sweep status {PROJECT}/{random_sweep_id} --trials")
