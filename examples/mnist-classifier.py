...
train_loader = torch.utils.data.DataLoader(
  torchvision.datasets.MNIST('~/.cache/torchvision-mnist/', train=True, download=True,
...
test_loader = torch.utils.data.DataLoader(
  torchvision.datasets.MNIST('~/.cache/torchvision-mnist/', train=False, download=True,
                             transform=torchvision.transforms.Compose([
                               torchvision.transforms.ToTensor(),
                               torchvision.transforms.Normalize(
                                 (0.1307,), (0.3081,))
    ...
    def train(epoch):
      ...
      for batch_idx, (data, target) in enumerate(train_loader):
        ...
        if batch_idx % log_interval == 0:
            wandb.log(
                {
                    "train_percent_complete": 100. * batch_idx / len(train_loader),
                    "train_loss": loss,
                },
